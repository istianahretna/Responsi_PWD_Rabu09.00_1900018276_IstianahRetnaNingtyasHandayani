...
<html lang="en">
  <head>
    ...
    <title>Form Kelola Produk</title>
  </head>
...
<div class="row no-gutters mt-5">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-3">
        <div class="row">
                    <div class="col-md-12">
                     <h2>Forms Kelola Produk </h2><hr> <br>
                        
                        <a style=" width:100px; height:30px;" href="tambah.php" class="btn btn-success btn-sm m-2"> Tambah </a>
                        <a href="lap_produk.php" class="btn btn-primary btn-sm m-2" style="margin-left: 5px; width:100px; height:30px;"> Cetak </a>
                        <a href="barang_json.php" class="btn btn-success btn-sm m-2" style="margin-left: 5px; width:100px; height:30px;"> JSON </a>
                        <a href="barang_xml.php" class="btn btn-primary btn-sm m-2" style="margin-left: 5px; width:100px; height:30px;"> XML </a>
                        <a href="akses_produk.php" class="btn btn-success btn-sm m-2" style="margin-left: 5px; width:100px; height:30px;"> Web Service </a>
                        <br><br>
...
<?php if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $sql="select * from data_barang where nama_produk like'%".$cari."%'"; // digunakan untuk memfilter data yang akan di cari
    $tampil = mysqli_query($conn,$sql); //menjalankan query dari variable con yang diambil dari file koneksi.php
    }else{ 
    $sql="select * from data_barang"; // untuk mengambil dari semua data pada table data barang
...
?>
            ...
            //atau array numerik
                    ...
                    while($user_data = mysqli_fetch_array($tampil)) {  
                        ...
                        echo "<td>".$user_data['harga_produk']."</td>"; 
                        echo "<td>".$user_data['berat_produk']."</td>"; 
                        echo "<td>".$user_data['stok']."</td>"; 
                        echo "<td><a href='edit.php?id_produk=$user_data[id_produk]' class='btn btn-warning btn-sm'>Edit</a> 
                                     <a href='delete.php?id_produk=$user_data[id_produk]' class='btn btn-danger btn-sm'>Delete</a>                         </td>
                             </tr>";
                        }
                 ?>
