  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item active">
          <a class="nav-link active" aria-current="page" href="login.php">Login User</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div id="carouselExampleControls" class="carouseln slide" data-ride="carousel">
      ...
      <div class="card mr-2 ml-2 p-2" style="width: 15rem;">
            ...
            <div class="card-body">
              ...
              <a href="login.php" class="btn btn-warning">Rp 15.000</a>
          </div>
       </div>
       ...
       <div class="card mr-2 ml-2 p-2" style="width: 15rem;">
            ...
            <div class="card-body">
              ...
              <a href="login.php" class="btn btn-warning">Rp 12.000</a>
          </div>
       </div>
     ...
     <div class="card mr-2 ml-2 p-2" style="width: 15rem;">
            ...
            <div class="card-body">
              ...
              <a href="login.php" class="btn btn-warning">Rp 13.000</a>
          </div>
       </div>
       ...
       <div class="card mr-2 ml-2 p-2" style="width: 15rem;">
            ...
            <div class="card-body">
              ...
              <a href="login.php" class="btn btn-warning">Rp 14.000</a>
          </div>
       </div>
